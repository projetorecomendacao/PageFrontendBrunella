  ...
  geraFormGroup(data?: Malnutrition): FormGroup {
    if (data){
      this.malnutritionForm = this.fb.group({
        ...
        q31_stress_illness_hospitalization: [{value:data.getQ31(),disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q32_bmi_less22: [{value:data.getQ32(),disabled:true}, [Validators.required, Validators.maxLength(1)]],
    ...
    else 
    {
      this.malnutritionForm = this.fb.group({
        ...
        q31_stress_illness_hospitalization: [{value:'',disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q32_bmi_less22: [{value:'',disabled:true}, [Validators.required, Validators.maxLength(1)]],
