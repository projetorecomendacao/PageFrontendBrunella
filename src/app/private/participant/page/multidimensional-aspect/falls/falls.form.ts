  ...
  geraFormGroup(data?: Falls): FormGroup {
    if (data){
      this.fallsForm = this.fb.group({
        ...
        q92_older_than75: [{value:data.getQ92(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q93_female: [{value:data.getQ93(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q94_cognitive_alterations: [data.getQ94(), [Validators.required, Validators.maxLength(1)]],
        q95_av_ds_commitment: [{value:data.getQ95(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q96_visual_deficit: [{value:data.getQ96(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q97_domestic_risks: [{value:data.getQ97(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q98_behavior_risk: [{value:data.getQ98(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q99_inactivity: [{value:data.getQ99(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q100_prior_ave: [{value:data.getQ100(), disabled:true}, [Validators.required, Validators.maxLength(1)]],
    ...
    else 
    {
      this.fallsForm = this.fb.group({
        ...
        q92_older_than75: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q93_female: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q94_cognitive_alterations: ['', [Validators.required, Validators.maxLength(1)]],
        q95_av_ds_commitment: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q96_visual_deficit: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q97_domestic_risks: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q98_behavior_risk: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q99_inactivity: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
        q100_prior_ave: [{value:'', disabled:true}, [Validators.required, Validators.maxLength(1)]],
